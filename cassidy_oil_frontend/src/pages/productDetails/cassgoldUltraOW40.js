...
import sample from "../../images/CassgoldUltraOW40Sample.png";
...
export default function CassgoldUltraOW40() {
            ...
            <div className="section2 px-5">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">CASSGOLD ULTRATECH FULLY SYNTHETIC MOTOR OIL 0W-40 API SN/CF</li>
                    </ol>
                </nav>
                ...
                <div className="details">
                    ...
                    <div className="benefits mt-5">
                        ...
                        <ul>
                            ...
                            <li>Enhanced wear protection to various critical engine parts such as cylinder liner, piston rings, valves, cams etc. which increases engine life. Multigrade oil advantage which protects engine parts at the point of engine start up. </li>
