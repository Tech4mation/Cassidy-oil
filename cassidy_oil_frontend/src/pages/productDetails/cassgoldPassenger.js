...
import sample from "../../images/cassgoldPassengerSample.svg";
...
export default function CassgoldPassenger() {
    return (
            ...
            <div className="section2 px-5">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">CASSGOLD PASSENGER MOTOR OIL 20W-50 API SG/CF-4</li>
                    </ol>
                </nav>
                ...
                <div className="details">
                    <div className="description">
                        <h4>DESCRIPTION</h4>    
                        <p>CASSGOLD PASSENGER MOTOR OIL 20W-50 API SG/CF-4 is an universal petrol and diesel multigrade engine oil which is developed to be used in earlier generation passenger cars, fleet vehicles, SUVs, light public transport vehicles. CASSGOLD PASSENGER MOTOR OIL 20W-50 API SG/CF-4 is an all-year motor oil which is designed to run under various operating loads and temperatures. </p>
                    </div>
                    <div className="performance mt-5">
                        <h4>PERFORMANCE</h4>    
                        <p>Meets the requirements of SAE 20W-50, API SG-CF4.</p>
                    </div>
                    <div className="application mt-5">
                        <h4>APPLICATION</h4>    
                        <p>CASSGOLD PASSENGER MOTOR OIL 20W-50 API SG/CF-4 can be used in earlier generation passenger cars, fleet cars, SUVs, MUVs, light and heavy commercial vehicles running with petrol or diesel as their fuel source. OEM recommended drain interval is to be followed.</p>
                    </div>
