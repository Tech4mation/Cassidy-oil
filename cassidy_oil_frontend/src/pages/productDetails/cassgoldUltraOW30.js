...
export default function CassgoldUltraOW30() {
            ...
            <div className="section2 px-5">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">CASSGOLD ULTRATECH FULLY SYNTHETIC MOTOR OIL 0W-30 API SN/CF</li>
                    </ol>
                </nav>
